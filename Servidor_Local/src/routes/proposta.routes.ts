...
import authMiddelware, { autorized, isDwener } from "../security/auth.middelware.js";
...
router.put(propostaRouter.update,autorized([Role.ADMIN,Role.PRESTADOR,Role.EMPRESA]),isDwener(prestadorModel,"owner"),propostaControler.update)

router.delete(propostaRouter.delete,autorized([Role.ADMIN,Role.PRESTADOR,Role.EMPRESA]),isDwener(prestadorModel,"owner"),propostaControler.delete)
